                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                                ...
                                <br/>
                            <div class="col-md-6">
                                    <input id="gender" type="radio"  name="gender" required checked="checked" style="margin-top: 9px;"/>Male
                       ...
                       <div class="form-group row">
                                ...
                                <br/>
                            <div class="col-md-6">
                                    <input id="gender" type="date"  name="dob" class="form-control" required/>
                            </div>
                       </div>
                        <div class="form-group row">
                                <label for="dob" class="col-md-4 col-form-label text-md-right">{{ __('Telephone No.') }}</label>
                                <br/>
                            <div class="col-md-6">
